...
/**
 *
 * tuantuantuan - Test Class
 *
 * This class provides a basic testing framework for the microservice tuantuantuan. It was
 * generated by the CAE (Community Application Framework).
 *
 */
public class tuantuantuanTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(tuantuantuan.class.getCanonicalName(),"0.1");
  ...
  /**
   * 
   * Test for the tuantuantuan method.
   * 
   */
  @Test
  public void testtuantuantuan() {
    ...
    try {
      ...
      System.out.println("Result of 'testtuantuantuan': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
